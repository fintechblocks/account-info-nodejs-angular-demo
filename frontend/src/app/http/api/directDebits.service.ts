...
import { OBReadDirectDebit1 } from '../model/oBReadDirectDebit1';
...
export class DirectDebitsService {
    ...
    public getAccountsAccountIdDirectDebits(AccountId: string, Authorization: string, x_fapi_financial_id?: string, x_fapi_customer_last_logged_time?: string, x_fapi_customer_ip_address?: string, x_fapi_interaction_id?: string, x_customer_user_agent?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<OBReadDirectDebit1>(`${this.basePath}/accounts/${encodeURIComponent(String(AccountId))}/direct-debits`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getDirectDebits(Authorization: string, x_fapi_financial_id?: string, x_fapi_customer_last_logged_time?: string, x_fapi_customer_ip_address?: string, x_fapi_interaction_id?: string, x_customer_user_agent?: string, observe?: 'body', reportProgress?: boolean): Observable<OBReadDirectDebit1>;
    public getDirectDebits(Authorization: string, x_fapi_financial_id?: string, x_fapi_customer_last_logged_time?: string, x_fapi_customer_ip_address?: string, x_fapi_interaction_id?: string, x_customer_user_agent?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<OBReadDirectDebit1>>;
    public getDirectDebits(Authorization: string, x_fapi_financial_id?: string, x_fapi_customer_last_logged_time?: string, x_fapi_customer_ip_address?: string, x_fapi_interaction_id?: string, x_customer_user_agent?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<OBReadDirectDebit1>>;
    public getDirectDebits(Authorization: string, x_fapi_financial_id?: string, x_fapi_customer_last_logged_time?: string, x_fapi_customer_ip_address?: string, x_fapi_interaction_id?: string, x_customer_user_agent?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (Authorization === null || Authorization === undefined) {
        ...
        return this.httpClient.get<OBReadDirectDebit1>(`${this.basePath}/direct-debits`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
