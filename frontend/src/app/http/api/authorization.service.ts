...
export class AuthorizationService {
  ...
  public getAuthorizationUrl(AccountRequestId): Observable<any> {

    let headers = this.defaultHeaders;
    let queryParameters = new HttpParams({ encoder: new CustomHttpUrlEncodingCodec() });
    if (AccountRequestId !== undefined) {
      queryParameters = queryParameters.set('AccountRequestId', AccountRequestId);
  }
